					...
					<div class="header-wrapper clearfix">
						...
						<div class="header-nav">
							<ol class="button">
								...
								<li><a id="previous" href="/works/diesel/"></a></li>
								<li><a id="next" href="/works/truck/"></a></li>
							</ol>
						</div>
				...
				<div class="project-body">
						...
						<div class="single-unit-end">
							<div class="single-unit-wrapper-noheight">
								<div class="project-highlight">
									<h3>Research about vehicle design at Tsinghua University</h3>
									<h3>Course project for EECS 545 Machine Learning at Univ. of Michigan</h3>
								</div>
					...
					<div class="full-unit clearfix">
						<div class="three-unit">
							<div class="three-unit-wrapper-noheight">
								<div class="project-text">
									<h3>INVESTIGATION</h3>
									<p>More information about this part will be updated soon</p>
								</div>
							</div>
						</div>
						<div class="single-unit-end">
					...
					<div class="full-unit clearfix">
						...
						<div class="single-unit-end">
							<div class="single-unit-wrapper-noline">
								<div class="single-side-info">
									<div class="comments">
									Analogy of human face on FAW J6 semi-truck
									</div>
								</div>
							</div>
						</div>
					...
					<div class="full-unit clearfix">
						...
						<div class="single-unit-end">
							<div class="single-unit-wrapper-noline">
								<div class="single-side-info">
									<div class="comments">
									Analogy of human face on Benz Actros III
									</div>
								</div>
							</div>
						</div>
					...
					<div class="full-unit clearfix">
						<div class="three-unit">
							<div class="three-unit-wrapper-noline">
								<div class="pict">
									<img src="roteep_4.jpg" style="width:580px"></img>
								</div>
							</div>
						</div>
						<div class="single-unit-end">
