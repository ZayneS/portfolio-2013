					...
					<div class="header-wrapper clearfix">
						...
						<div class="header-nav">
							<ol class="button">
								...
								<li><a id="previous" href="/works/colorworks/"></a></li>
								<li><a id="next" href="/works/carface/"></a></li>
							</ol>
						</div>
						...
						<div class="three-unit">
							<div class="three-unit-wrapper-noheight">
								<div class="project-text">
									<p>Diesel men's aftershave is a product design attached to the L'Oreal business competition "BrandStrom 2010"</p>
									<p>The inspiration of the design comes from the image of chinese lock.</p>
								</div>
							</div>
						</div>
						<div class="single-unit-end">
							<div class="single-unit-wrapper-noheight">
								<div class="project-highlight">
									<h3>L'oreal Brandstrom Competition 2010</h3>
								</div>
								<div class="project-tools">
									<h3>Luxury Design</h3>
									<h3>Personal</h3>
									<h3>Sketching</h3>
									<h3>Rhino 3D modeling</h3>
								</div>
							</div>
						</div>
					</div>
					<div class="full-unit clearfix">
						<div class="three-unit">
							<div class="three-unit-wrapper-noline">
								<div class="pict">
									<img src="diesel_0.jpg" style="width:580px"></img>
								</div>
							</div>
						</div>
						<div class="single-unit-end">
					...
					<div class="full-unit clearfix">
						...
						<div class="single-unit-end">
							<div class="single-unit-wrapper-noline">
								<div class="single-side-info">
									<div class="comments">
									The grooming pomade can be separated/detached from the aftershave.
									</div>
								</div>
							</div>
						</div>
