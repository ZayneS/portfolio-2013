...
?>
			<div class="main-column clearfix">
				...
				<ol class="grid clearfix">
					<!-- <li class="full-unit feature-height clearfix">
						<div class="year-tag">
							<p>Featured</p>
						</div>
						<div class="full-unit-wrapper clearfix">
							<div class="blank" style="height:30px"></div>
							<div class="feature-thumb">
								<a href="/works/yogurt/">
								<img src="/static/thumb_yog_4.jpg"></img>
								</a>
							</div>
							<div class="feature-intro">
								<h3>YOGURT</h3>
								<h3>Viz. online distraction
								</h3>
								<div class="tag">Tag: Data visualization</div>
								<p>Yogurt is a Google Chrome extension providing awareness of online distraction. It was the final project in CS448B Data Visualization at Stanford.</p>
							</div>
						</div>
					</li> -->
					<li class="double-unit">
						...
						<div class="double-unit-wrapper">
							...
							<div class="brief-intro">
								<h3>HAPPYLABEL</br>
								Crowdsourcing image label game
								</h3>
					...
					<li class="double-unit">
						...
						<div class="double-unit-wrapper">
							<a href="/works/musicviz/">
							<div class="brief-intro">
								<h3>CHART-VIZ</br>
								Artistis on Billboard Top 10
								</h3>
								<div class="tag">Tag: Data visualization</div>
					...
					<li class="single-unit thumb-height">
						<div class="year-tag">
							<p>2011</p>
						</div>
						<div class="single-unit-wrapper">
							<a href="/works/carface/">
							<div class="brief-intro">
								<h3>Car Front</br>
								& Human Face
								</h3>
					...
					<li class="single-unit-end thumb-height">
						<div class="year-tag">
							<p>2008</p>
						</div>
						<div class="single-unit-wrapper">
