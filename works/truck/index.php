					...
					<div class="header-wrapper clearfix">
						...
						<div class="header-nav">
							<ol class="button">
								...
								<li><a id="previous" href="/works/carface/"></a></li>
								<li><a id="next" href="/works/epet/"></a></li>
							</ol>
						</div>
					...
					<div class="full-unit clearfix">
						...
						<div class="full-unit-wrapper">
							<div class="project-title">
								<h3>CHANA TRUCK</br>
								Next generational Semi-truck design
								</h3>
								<p>Tags: Industrial design, Vehicle design
								</p>
							</div>
						...
						<div class="single-unit-end">
							<div class="single-unit-wrapper-noheight">
								<div class="project-highlight">
									<h3>Studio project at Tsinghua University</h3>
									<h3></h3>
								</div>
